...
<title><?php echo get('tag');?> - {pboot:sitetitle}</title>
...
<div class="container">
  <div class="row">
    <div class="subsidiary box">
      <div class="bulletin fourfifth"> <span class="sixth">当前位置：</span> <span class="current"> TAG标签：<?php echo get('tag');?></span> </div>
    </div>
  </div>
  <!--right--> 
