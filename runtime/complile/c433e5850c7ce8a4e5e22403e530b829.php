...
<div class="container">
  <div class="row">
    <div class="subsidiary box">
      <div class="bulletin fourfifth"> <span class="sixth">当前位置：</span> <span class="current"> {pboot:position}</span> </div>
    </div>
  </div>
  <!--right--> 
    ...
    <ul id="post_container" class="masonry clearfix">
      ...
      <li class="post box row ">
        ...
        <div class="info"> <span class="info_date info_ico">[list:date style=Y-m-d]</span> <span class="info_views info_ico">[list:visits] </span> 
          <span class="info_category info_ico"><a href="[nav:link]" rel="category">[list:sortname]</a></span> </div>
      </li>
      {/pboot:list}
    </ul>
    <div class="clear"></div>
