...
<meta name="author" content="www.adminbuy.cn K4"/>
...
<div id="sidebar">
  ...
  <div class="slider row"> 
    ...
    <div id="focus">
      <ul>
        {pboot:list scode=* num=5 istop=1}
        <li> <a href="[list:link]" target="_blank" title="[list:title]"> <img src="[list:ico]" width="650" height="370" alt="111" /> </a>
          <div class="flex-caption">
            <h2><a href="[list:link]"  target="_blank" >[list:title]</a></h2>
            <p class="slides_entry"> [list:description lencn=80]</p>
            <p class="btn"><a href="[list:link]"  target="_blank" >查看详情</a></p>
          </div>
        </li>
        {/pboot:list}
      </ul>
  ...
  <div class="mainleft">
    <ul id="post_container" class="masonry clearfix">
      {pboot:list scode=* num=18 order=date}
      <li class="post box row ">
        <div class="thumbnail"> <a href="[list:link]" class="zoom"  target="_blank" title="[list:title]"> <img src="[list:ico]" alt="[list:title]" />
          <div class="zoomOverlay"></div>
          </a> </div>
        <div class="article">
          <h2><a href="[list:link]"  target="_blank" title="[list:title]">[list:title]</a></h2>
        </div>
        <div class="info"> <span class="info_date info_ico">[list:date style=Y-m-d]</span> <span class="info_views info_ico">[list:visits] </span> 
          <span class="info_category info_ico"><a href="[list:sortlink]" rel="category">[list:sortname]</a></span> </div>
      </li>
      {/pboot:list}
    </ul>
    <div class="clear"></div>
...
<div id="footer">
  ...
  <div class="copyright">
    <p>{pboot:sitecopyright} <a href="https://beian.miit.gov.cn/" target="_blank" rel="nofollow">{pboot:siteicp}</a> <a href="{pboot:sitedomain}/sitemap.xml" target="_blank">XML地图</a> <a href="http://www.adminbuy.cn" target="_blank">网站源码</a></p>
  </div>
</div>
</div>
<!--gototop-->
